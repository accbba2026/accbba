  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        {/* Header Section */}
        <div className="mb-8">
          <h1 className="text-3xl text-center font-bold text-gray-900">Faculty Dashboard</h1>
          <p className="text-gray-600 text-center mt-1">Welcome back, Faculty Member</p>
        </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              ...
              <Link
                ...
                className="group relative overflow-hidden bg-gradient-to-br from-red-500 to-red-700 rounded-xl p-6 transition-all duration-300 hover:scale-105 hover:shadow-lg"
              >
                <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mt-10 -mr-10"></div>
                <div className="absolute bottom-0 left-0 w-20 h-20 bg-white/10 rounded-full -mb-10 -ml-10"></div>
                <div className="relative z-10">
