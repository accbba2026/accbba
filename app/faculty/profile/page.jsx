  ...
  useEffect(() => {
    if (fullUserData) {
      ...
      setFormData({
        ...
        role: fullUserData.role || "faculty",
      });
    }
  }, [fullUserData]);
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden sticky top-24">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center gap-3 text-gray-600">
                  ...
                  <span className="text-sm">
                    {displayData?.designation || "Not provided"}
                  </span>
                </div>
                <div className="flex items-center gap-3 text-gray-600">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          required
                          className="w-full text-gray-700 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                        />
                      </div>
              ...
              <div className="p-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start gap-3">
                    <FaUserShield className="text-purple-600 text-xl mt-0.5" />
                    <div>
