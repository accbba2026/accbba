// app/api/auth/change-password-otp/route.js
import { connectToDatabase } from '@/app/lib/mongodb';
import User from '@/app/models/User';
import { NextResponse } from 'next/server';
import { generateAndStoreOTP } from '@/app/lib/otpService';
...
export async function POST(request) {
  try {
    ...
    console.log('📨 Change password request:', { loginType, email, collegeId });
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
          ...
          <div style="background-color: #f3f4f6; padding: 20px; border-radius: 8px;">
            <h3 style="color: #1f2937; margin-top: 0;">Password Change Request</h3>
            <p style="color: #4b5563;">Dear <strong>${user.name}</strong>,</p>
            <p style="color: #4b5563;">You requested to change your password. Use the verification code below:</p>
            ...
            <p style="color: #4b5563;">This code is valid for <strong>5 minutes</strong>.</p>
            <p style="color: #ef4444; font-size: 14px;"><strong>⚠️ Security Note:</strong> Never share this code with anyone.</p>
          </div>
