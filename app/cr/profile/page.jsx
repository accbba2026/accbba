  ...
  useEffect(() => {
    if (fullUserData) {
      ...
      setFormData({
        ...
        role: fullUserData.role || "cr",
        semester: fullUserData.semester || "N/A",
        session: fullUserData.session || "N/A",
      });
    }
  }, [fullUserData]);
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="mb-8">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold text-gray-900">CR Profile</h1>
          </div>
          <p className="text-gray-600 mt-1 ml-11">
            View and manage your Class Representative profile information
          </p>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden sticky top-24">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center gap-3 text-gray-600">
                  ...
                  <span className="text-sm">
                    Semester:{" "}
                    <strong>{displayData?.semester || "N/A"}</strong>
                  </span>
                </div>
                <div className="flex items-center gap-3 text-gray-600">
                  <FaCalendarAlt className="text-gray-400" />
                  <span className="text-sm">
                    Session:{" "}
                    <strong>{displayData?.session || "N/A"}</strong>
                  </span>
                </div>
                <div className="flex items-center gap-3 text-gray-600">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          required
                          className="w-full text-gray-700 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        />
                        <p className="text-xs text-gray-500 mt-1">
                          Semester cannot be changed directly. Contact admin.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        />
                        <p className="text-xs text-gray-500 mt-1">
                          Session cannot be changed directly. Contact admin.
                        </p>
                      </div>
                    </div>
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          setFormData({
                            ...
                            role: displayData?.role || "cr",
                            semester: displayData?.semester || "N/A",
                            session: displayData?.session || "N/A",
                          });
                          setMessage({ type: "", text: "" });
                        }}
              ...
              <div className="p-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start gap-3">
                    <FaUserShield className="text-green-600 text-xl mt-0.5" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <FaCalendarAlt className="text-green-600 text-xl mt-0.5" />
                    <div>
