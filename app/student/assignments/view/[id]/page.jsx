// app/student/assignments/view/[id]/page.jsx
      ...
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
          ...
          <div className="flex flex-wrap gap-4 text-sm text-gray-500">
            ...
            <span className="text-gray-600 font-semibold">
              ⌛ Submission: {new Date(assignment.submissionDate).toLocaleDateString("en-US", {
                day: "numeric",
                month: "short",
                year: "numeric",
                weekday: "long",
        ...
        {assignment.pdfUrl ? (
          !pdfError ? (
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Cannot Preview PDF</h3>
              <p className="text-gray-600 mb-4">The PDF cannot be displayed in the browser due to security restrictions.</p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <a href={assignment.pdfUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                  <FiFileText /> Open in New Tab
                </a>
                <a href={assignment.pdfUrl} download className="inline-flex items-center gap-2 px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
                  <FiDownload /> Download PDF
                </a>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            <p className="text-gray-600">No PDF file available for this assignment.</p>
          </div>
        )}
      </div>
    </div>
